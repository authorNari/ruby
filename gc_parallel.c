...
init_par_gc(rb_objspace_t *objspace)
{
    ...
    for (i = 0; i < num_workers; i++) {
        ...
        objspace->par_mark.deques[i].type = DEQUE_DATA_ROOTS_PTR;
        objspace->par_mark.deques[i].overflow_stack.type = DEQUE_DATA_ROOTS_PTR;
